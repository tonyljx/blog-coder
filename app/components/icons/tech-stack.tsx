...
export const VSCodeIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} fill="none" viewBox="0 0 100 100">
    ...
    <g mask="url(#vscode-mask)">
      ...
      />
      <g filter="url(#vscode-shadow-bottom)">
        <path
          fill="#007ACC"
      ...
      <g filter="url(#vscode-shadow-side)">
        <path
          fill="#1F9CF0"
    ...
    <defs>
      ...
      >
        ...
        <feBlend in2="BackgroundImageFix" mode="overlay" result="dropShadow" />
        <feBlend in="SourceGraphic" in2="dropShadow" result="shape" />
      </filter>
      <filter
        id="vscode-shadow-side"
        width="47.917"
        height="116.151"
        x="60.417"
        y="-8.076"
